      ...
      <div className="relative z-10 h-full flex flex-col p-2 sm:p-3 lg:p-4 overflow-hidden">
          ...
          <div className="flex flex-col space-y-1 sm:space-y-1.5 lg:space-y-2">
            ...
            <div className="text-left">
              <div className="flex items-center space-x-1 sm:space-x-1.5 mb-0.5 sm:mb-1">
                ...
                <h1 className="text-base sm:text-lg lg:text-2xl xl:text-3xl font-bold text-white typing-animation" style={{direction: currentLanguage === 'ar' ? 'rtl' : 'ltr'}}>
                  {t('home.title')}
                </h1>
              </div>
              <p className="text-[10px] sm:text-xs lg:text-sm text-white/90 font-medium" style={{direction: currentLanguage === 'ar' ? 'rtl' : 'ltr'}}>
                {t('home.subtitle')}
              </p>
            </div>
          </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl lg:rounded-2xl p-2 sm:p-3 lg:p-4 border border-white/20">
              <div className="flex items-center space-x-2 sm:space-x-2.5 lg:space-x-3 mb-1 sm:mb-1.5 lg:mb-2">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-sm sm:text-base lg:text-lg font-bold text-white slide-in truncate" style={{direction: currentLanguage === 'ar' ? 'rtl' : 'ltr'}}>
                    {currentFeatureData.title}
                  </h3>
                  <p className="text-white/80 text-xs sm:text-sm line-clamp-2" style={{direction: currentLanguage === 'ar' ? 'rtl' : 'ltr'}}>
                ...
                <div className="bg-white rounded-md sm:rounded-lg lg:rounded-xl p-1.5 sm:p-2 lg:p-2.5 shadow-2xl">
                  ...
                  <div className="text-center mb-1 sm:mb-1.5 lg:mb-2">
                    <div className="flex items-center justify-center space-x-1 mb-0.5 sm:mb-1">
                      ...
                      <div className="min-w-0 flex-1">
                        <h3 className="text-[10px] sm:text-xs lg:text-sm font-bold text-gray-800 truncate" style={{direction: currentLanguage === 'ar' ? 'rtl' : 'ltr'}}>
                          {t('dialer.aiSalesAgent')}
                        </h3>
                        <p className="text-[9px] sm:text-[10px] text-gray-600 truncate" style={{direction: currentLanguage === 'ar' ? 'rtl' : 'ltr'}}>
                    ...
                    <div className="space-y-0.5 sm:space-y-1">
                      <div className="flex items-center justify-center space-x-0.5 sm:space-x-1">
                        {callStatus === 'dialing' && (
                          <>
                            ...
                            <span className="text-[9px] sm:text-[10px] text-yellow-600 font-medium" style={{direction: currentLanguage === 'ar' ? 'rtl' : 'ltr'}}>
                              {t('dialer.dialing')}
                            </span>
                          </>
                        )}
                        {callStatus === 'connecting' && (
                          <>
                            ...
                            <span className="text-[9px] sm:text-[10px] text-blue-600 font-medium" style={{direction: currentLanguage === 'ar' ? 'rtl' : 'ltr'}}>
                              {t('dialer.connecting')}
                            </span>
                          </>
                        )}
                        ...
                        {callStatus === 'idle' && (
                          <>
                            ...
                            <span className="text-[9px] sm:text-[10px] text-gray-600 font-medium" style={{direction: currentLanguage === 'ar' ? 'rtl' : 'ltr'}}>
                      ...
                      <div className="bg-gray-100 rounded-md p-1 sm:p-1.5">
                        ...
                        <p className="text-[9px] text-gray-500 truncate" style={{direction: currentLanguage === 'ar' ? 'rtl' : 'ltr'}}>
                  ...
                  <div className="mt-1 sm:mt-1.5 pt-0.5 sm:pt-1 border-t border-gray-200">
                    <div className="grid grid-cols-3 gap-0.5 sm:gap-1 text-center">
                      <div>
                        <p className="text-[9px] text-gray-500" style={{direction: currentLanguage === 'ar' ? 'rtl' : 'ltr'}}>
                          {t('dialer.duration')}
                        </p>
                      ...
                      <div>
                        ...
                        <p className="text-[9px] font-semibold text-blue-600" style={{direction: currentLanguage === 'ar' ? 'rtl' : 'ltr'}}>
                          {t('dialer.excellent')}
                        </p>
                      </div>
                      <div>
                ...
                <div className="bg-white rounded-md sm:rounded-lg lg:rounded-xl p-1.5 sm:p-2 shadow-2xl">
                  ...
                  <div className="flex items-center justify-between mb-1 sm:mb-1.5">
                    <div className="flex items-center space-x-0.5 sm:space-x-1">
                      ...
                      <span className="font-semibold text-gray-800 text-[10px] sm:text-xs lg:text-sm" style={{direction: currentLanguage === 'ar' ? 'rtl' : 'ltr'}}>
                        ...
                        {message.type === "user" && (
                          <div className="flex justify-end">
                            <div className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-1.5 sm:px-2 py-1 rounded-lg sm:rounded-xl rounded-br-md max-w-[85%]">
                              <p className="text-[10px] sm:text-xs" style={{direction: message.text.includes('مرحبا') || message.text.includes('هل') ? 'rtl' : 'ltr'}}>
                                {message.text}
                              </p>
                            </div>
                          </div>
                        ...
                        {message.type === "ai" && (
                          <div className="flex justify-start">
                            <div className="bg-gray-100 px-1.5 sm:px-2 py-1 rounded-lg sm:rounded-xl rounded-bl-md max-w-[85%]">
                              <p className="text-[10px] sm:text-xs text-gray-800" style={{direction: message.text.includes('نعم') || message.text.includes('أستطيع') ? 'rtl' : 'ltr'}}>
                                {message.text}
                              </p>
                              {message.features && (
                                <div className="mt-0.5 sm:mt-1 space-y-0.5">
                                  {message.features.map((feature, featureIndex) => (
                                    <div key={featureIndex} className="flex items-center space-x-0.5 sm:space-x-1">
                                      ...
                                      <span className="text-[9px] sm:text-[10px] text-gray-600" style={{direction: feature.includes('اللهجة') || feature.includes('العربية') ? 'rtl' : 'ltr'}}>
                                        {feature}
                                      </span>
                                    </div>
                                  ))}
          ...
          {[
            ...
            return (
              <div key={index} className="bg-white/10 backdrop-blur-sm rounded-md sm:rounded-lg lg:rounded-xl p-1 sm:p-1.5 lg:p-2 border border-white/20 text-center fade-in" style={{animationDelay: `${index * 0.1}s`}}>
                ...
                <div className="text-[9px] sm:text-[10px] lg:text-xs text-white/80 line-clamp-1" style={{direction: currentLanguage === 'ar' ? 'rtl' : 'ltr'}}>{stat.label}</div>
              </div>
            );
          })}
        </div>
        ...
        <div className="mt-1 sm:mt-1.5 lg:mt-2 flex-shrink-0">
          ...
          <div className="text-center mt-0.5 sm:mt-0.5 lg:mt-1">
            <span className="text-white/80 text-[9px] sm:text-[10px] lg:text-xs" style={{direction: currentLanguage === 'ar' ? 'rtl' : 'ltr'}}>
