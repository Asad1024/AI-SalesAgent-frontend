        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 animate-fade-in-up">
              {/* Badge */}
              <div className="inline-flex items-center px-4 py-2 bg-brand-100 dark:bg-brand-900/20 text-brand-600 dark:text-brand-400 rounded-full text-sm font-medium">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-slate-700 dark:text-slate-300">24/7 AI-powered sales calls</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-brand-500 rounded-full flex items-center justify-center">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-slate-700 dark:text-slate-300">300% increase in conversions</span>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/login">
                  <Button 
                    size="lg" 
                    className="bg-gradient-to-r from-brand-500 via-brand-600 to-brand-700 hover:from-brand-600 hover:via-brand-700 hover:to-brand-800 text-white px-8 py-4 text-lg font-semibold"
                  >
                ...
                <Button 
                  variant="outline" 
                  size="lg"
                  className="border-2 border-brand-500 text-brand-600 dark:text-brand-400 hover:bg-brand-50 dark:hover:bg-brand-900/20 px-8 py-4 text-lg font-semibold"
                >
            ...
            <div className="relative animate-fade-in-up animate-delay-200">
              <div className="relative bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-8 border border-slate-200 dark:border-slate-700">
                ...
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="h-2 w-16 bg-slate-100 dark:bg-slate-700 rounded mt-1"></div>
                    </div>
                  </div>
                  <div className="flex space-x-2">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <div className="bg-slate-100 dark:bg-slate-700 rounded-lg p-3">
                        <div className="h-2 w-3/4 bg-slate-300 dark:bg-slate-600 rounded mb-2"></div>
                  ...
                  <div className="flex items-start space-x-3 justify-end">
                    <div className="flex-1">
                      <div className="bg-brand-500 rounded-lg p-3 text-white">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <div className="bg-slate-100 dark:bg-slate-700 rounded-lg p-3">
                        <div className="h-2 w-4/5 bg-slate-300 dark:bg-slate-600 rounded mb-2"></div>
                        <div className="h-2 w-3/5 bg-slate-300 dark:bg-slate-600 rounded"></div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 pt-6 border-t border-slate-200 dark:border-slate-700">
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div>
                      <div className="text-2xl font-bold text-brand-600 dark:text-brand-400">95%</div>
              ...
              {/* Floating Elements */}
              <div className="absolute -top-4 -right-4 w-16 h-16 bg-brand-500 rounded-full flex items-center justify-center shadow-lg animate-bounce">
